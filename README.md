...
This repository contains a standalone backfill utility:

```text
honcho_backfill.py
```

It is designed for one-time or occasional migrations/backfills from Hermes' local session history into a self-hosted or hosted Honcho instance.
